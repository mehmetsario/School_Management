...
@section('css')
    <!--begin::Page Vendor Stylesheets(used by this page)-->
        @if (App::getLocale() == 'ar')
             <link href="{{ URL::asset('assets/plugins/custom/datatables/datatables.bundle.rtl.css') }}" rel="stylesheet" type="text/css" />
        @else
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-center flex-column py-5">
                            ...
                            <div class="symbol symbol-100px symbol-circle mb-7">
                                <img src="{{URL::asset('assets/media/avatars/150-1.jpg')}}" alt="image" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Name-->
                        ...
                        <div id="kt_user_view_details" class="collapse show">
                            <div class="pb-5 fs-6">
                                ...
                                <div class="text-gray-600">20 Dec 2021, 8:43 pm</div>
                                <!--begin::Details item-->
                            </div>
                        </div>
                        <!--end::Details content-->
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle table-row-dashed fw-bold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/customer/c_613229419bf2b/not_found</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/invoices/in_4729_9234/payment</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-end min-w-200px">20 Dec 2021, 2:40 pm</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        <!--begin::Table row-->
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/invoice/in_9882_1847/invalid</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-end min-w-200px">24 Jun 2021, 10:30 am</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        <!--begin::Table row-->
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/invoice/in_3149_5985/invalid</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/invoices/in_9535_9516/payment</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                            ...
                            <div class="card-body py-0">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5" id="kt_table_customers_events">
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Event=-->
                                        <!--begin::Timestamp=-->
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2021, 5:30 pm</td>
                                        <!--end::Timestamp=-->
                                    </tr>
                                    <!--end::Table row-->
                                    <!--begin::Table row-->
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Event=-->
                                        <!--begin::Timestamp=-->
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2021, 10:30 am</td>
                                        <!--end::Timestamp=-->
                                    </tr>
                                    <!--end::Table row-->
                                    <!--begin::Table row-->
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Event=-->
                                        <!--begin::Timestamp=-->
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">22 Sep 2021, 9:23 pm</td>
                                        <!--end::Timestamp=-->
                                    </tr>
                                    <!--end::Table row-->
                                    <!--begin::Table row-->
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Event=-->
                                        <!--begin::Timestamp=-->
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2021, 6:05 pm</td>
                                        <!--end::Timestamp=-->
                                    </tr>
                                    <!--end::Table row-->
                                    <!--begin::Table row-->
